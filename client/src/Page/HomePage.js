...
function HomePage() {
    ...
    useEffect(() => {
        const capitalizedSearchTerm = "Spp1";
    ...
    return (
        <>
            <div id="container">
                ...
                <div id="wrapper">
                    <div id="content">
                        <h1>Welcome to WhiteMatterWiki</h1>
                ...
                <div id="extra">
                    ...
                    <div id="card">
                        ...
                        <Graph
                            graph={graphData[0]}  // Assuming you want to display the first graph in the array
                            options={graphOptions}
                                style={{ height: "400px" }}  // Set a height for the graph container
                        />
                    )}
                    </div>
                    <div id="card">
